...
# Mapeamos los mensajes de Django a las clases de Bootstrap 5
MESSAGE_TAGS = {
...
SECRET_KEY = 'django-insecure-tw7qri59a@1k!8e0sa^^k@d-apu-+nmglnwg)dh%ft&w*a8z52'
...
LOGIN_URL = 'login'              # Nombre de la URL donde está el login
LOGIN_REDIRECT_URL = 'reporte:dashboard'      # A dónde va si el login es exitoso
LOGOUT_REDIRECT_URL = 'login'    # A dónde va al cerrar sesión

# 1. La sesión expirará en cuanto el usuario cierre el navegador
SESSION_EXPIRE_AT_BROWSER_CLOSE = True

# 2. (Opcional pero muy recomendado) Tiempo máximo de inactividad
SESSION_COOKIE_AGE = 3600 

# 3. Forzar que la sesión se guarde en cada solicitud para reiniciar el contador de inactividad
